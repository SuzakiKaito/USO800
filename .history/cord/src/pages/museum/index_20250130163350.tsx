        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.dataModal}>
            <div className={styles.modalContent}>
              <figure>
                <img  src="/images/cross.png" alt="バツボタン" />
              </figure>
              <figure>
                <img className={styles.prevArrow} src="/images/prevArrow.png" alt="" />
              </figure>
              <figure>
                <img  className={styles.nextArrow} src="/images/nextArrow.png" alt="" />
              </figure>
              <h4>2025年 1月</h4>
