...
export default function Main() {
  ...
  const sortThreadsByNiceCount = () => {
    const sortedThreads = [...threadsE].sort((a, b) => b.niceCount - a.niceCount);
  ...
  const [threadsE, setThreads] = useState([
    { id: 1, text: "100m走で世界新記録出しました", niceCount: 80,  isLiked: false, postTime: "40秒前" },
    { id: 2, text: "今日外に恐竜おったんやけど", niceCount: 2,  isLiked: false, postTime: "1分前" },
    { id: 3, text: "鼻からビー玉が出てきました", niceCount: 9,  isLiked: false, postTime: "2分前" },
    { id: 4, text: "僕、織田信長何ですけど何か質問...", niceCount: 34,  isLiked: false, postTime: "5分前" },
    { id: 5, text: "明日、東大模試受けてきます。", niceCount: 15,  isLiked: false, postTime: "8分前" },
    { id: 6, text: "ランボルギーニ乗り回してます。", niceCount: 40,  isLiked: false, postTime: "10分前" },
    { id: 7, text: "今、コロンビアにいます。お土産...", niceCount: 37,  isLiked: false, postTime: "12分前" },
    { id: 8, text: "魚になりました。", niceCount: 4,  isLiked: false, postTime: "15分前" },
    { id: 9, text: "腕がマシンガンになっちゃった", niceCount: 33,  isLiked: false, postTime: "20分前" },
    { id: 10, text: "公園で財布拾ったけど、誰の？", niceCount: 23,  isLiked: false, postTime: "22分前" },
  ]);
  ...
  //         ? {
  //             ...thread,
  //             isLiked: !thread.isLiked, // 状態をトグル
  //             niceCount: thread.isLiked ? thread.niceCount - 1 : thread.niceCount + 1, // カウントを増減
  //           }
  //         : thread
  //     )
  //   );
    ...
    <div className={styles.boxContent}>
      <div className={styles.mainContent}>
        ...
        <div className={styles.threadContent}>
          ...
          {threadsE.map((thread) => (
            ...
            <div className={styles.niceContent}>
                <figure
                  // onClick={() => handleLikeClick(thread.id)} // クリックイベントを追加
                  className={`${styles.niceIcon} ${thread.isLiked ? styles.liked : ""}`} // 状態によるクラスの適用
                >
      ...
      <div className={styles.footerContent}>
        ...
        >
          ...
          {isExpanded && (
            <div
              className={`${styles.sortBox} ${styles.sortHidden}`}
              onClick={sortThreadsByNiceCount}
            >
              <figure>
                <img src="/images/sortIcon.png" alt="並び替えアイコン" />
              </figure>
