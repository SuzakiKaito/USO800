...
export default function Main() {
  ...
  const fetchThreads = async () => {
    try {
      ...
      // 投稿されたデータが投稿時間(postTime)が新しいスレッドが上にくる
    // const sortedThreads = threadsData.sort((a, b) => {
    //   const timeA = a.postTime.toDate ? a.postTime.toDate() : new Date(a.postTime);
    //   const timeB = b.postTime.toDate ? b.postTime.toDate() : new Date(b.postTime);
    //   return timeB - timeA; // Newest threads first
    // });
