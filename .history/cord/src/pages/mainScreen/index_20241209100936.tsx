...
export default function Main() {
  ...
  const [threads, setThreads] = useState([
    ...
    { id: 5, text: "明日、東大模試受けてきます。", niceCount: 0, postTime: "5分前" },
    { id: 6, text: "ランボルギーニ乗り回してます。", niceCount: 0, postTime: "5分前" },
    { id: 7, text: "今、コロンビアにいます。お土産何がいい？", niceCount: 0, postTime: "5分前" },
    { id: 8, text: "魚になりました。", niceCount: 0, postTime: "5分前" },
    { id: 9, text: "腕がマシンガンになっちゃった", niceCount: 0, postTime: "5分前" },
    { id: 10, text: "今、コロンビアにいます。お土産何がいい？", niceCount: 0, postTime: "5分前" },
