...
export default function Main() {
  const threads: Thread[] = useThreads(); // Firebase hook to get threads
  const [isModalVisible, setIsModalVisible] = useState(false);
  const [newThreadText, setNewThreadText] = useState("");
  const [sortedThreads, setSortedThreads] = useState<Thread[]>([]); // Explicit type for sortedThreads
  const [isExpanded, setIsExpanded] = useState(false); // Define isExpanded state
  ...
  useEffect(() => {
    ...
    const sorted = [...threads].sort((a, b) => new Date(b.postTime).getTime() - new Date(a.postTime).getTime());
      ...
      <div className={styles.footerContent}>
        ...
        <div className={styles.createContent}>
          <div
            ...
            onClick={toggleSortContent} // Use toggleSortContent here
          >
