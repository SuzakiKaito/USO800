...
export default function Main() {
  ...
  useEffect(() => {
    console.log(threads); // Check what data is fetched from Firebase
  }, [threads]);
  ...
  // Check if threads exist and filter them by category
  const filteredThreads = threads ? threads.filter((thread) => thread.category === "company") : [];
