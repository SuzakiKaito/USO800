...
export default function Main() {
  ...
  const filteredThreads = threads.filter((thread) => thread.category.includes("company")); // If category is an array
    ...
    <div className={styles.boxContent}>
      <div className={styles.mainContent}>
        ...
        <div className={styles.threadContent}>
          {/* Map through the filtered threads (only "company" category) */}
